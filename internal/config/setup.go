...
func SaveConfig(cfg *Config) error {
	...
	// Parse database URL if present
	if cfg.DatabaseURL != "" {
		dbConfig := ParseDatabaseURL(cfg.DatabaseURL)
		v.Set("database.type", dbConfig.Type)
		v.Set("database.host", dbConfig.Host)
		v.Set("database.port", dbConfig.Port)
		v.Set("database.name", dbConfig.Name)
		v.Set("database.user", dbConfig.User)
		v.Set("database.password", dbConfig.Password)
		v.Set("database.ssl_mode", dbConfig.SSLMode)
	}
