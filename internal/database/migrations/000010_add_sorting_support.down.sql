-- Migration 000010 Down: Revert sorting support (restore functions from 000008)

-- Restore get_top_pages without sorting params
DROP FUNCTION IF EXISTS get_top_pages(UUID, INTEGER, INTEGER, INTEGER, VARCHAR, VARCHAR, VARCHAR, VARCHAR, VARCHAR);
...
-- Restore get_breakdown without sorting params
